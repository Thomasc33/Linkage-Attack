...
class NTUDataLoaders(object):
    def __init__(self, dataset='NTU', case=0, aug=1, seg=30, train_X=None, train_Y=None, val_X=None, val_Y=None, test_X=None, test_Y=None):
...
if __name__ == '__main__':
    path = osp.join('./data/ntu', 'NTU_' + "CS" + '.h5')
    f = h5py.File(path, 'r')
    print(f['x'])
    print(f['y'])
    print(f['test_y'])
